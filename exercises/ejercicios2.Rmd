...
1. Importar los datos originales:
  ...
  * El resto de columnas tienen el formato `variable:dias`, es decir, la medición de distintas variables a lo largo del crecimiento de la planta (dias)

2. Convertir en un dataframe que tenga las variables: `treatment`, `cultivar`, `plantid`, `day`, `height`, `internodes`, `freshwt`

```{r}
# Source: https://www.fromthebottomoftheheap.net/2019/10/25/pivoting-tidily/
```