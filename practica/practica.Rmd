...
Vamos a trabajar con los ficheros "Estaciones.txt" y "Precios_2017_04_02.txt" ([fuente](https://geoportalgasolineras.es/#/Descargas)), que contienen información sobre el precio de distintos carburantes el día 2 de Abril de 2017 en estaciones de toda España:
  ...
  1. Leer fichero de precios. Asegúrate de que todas las variables de precios son numéricas.
  ...
  11. Añadir dos nuevas variables con los litros por euro de gasolina 95 y 98.
  ...
  18. Realizar un gráfico de barras con el conteo de estaciones por cada tipo de rótulo.
  
  19. Convertir la variable rótulo en un factor que tenga 6 niveles: los 5 rótulos más frecuentes y un nivel "Otros" con el resto. 
  
  20. Mas gráficas. Irene. Logitud, latitud, poner punto y escalar por precio de una gasolinera y colorear por el rótulo. Pintarlo para ver que tiene sentido.
